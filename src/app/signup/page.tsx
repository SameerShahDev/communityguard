    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0c0e12] px-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400">Start protecting your community today.</p>
        </div>
        ...
        <div className="bg-[#111318] border border-white/5 rounded-3xl p-8 shadow-2xl">
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ...
            <Link href="/login" className="text-[#a2a9fa] hover:text-white font-semibold transition-colors">
              Sign in
            </Link>
          </p>
        </div>
